			...
			<div class="creature-controls">\
				...
				<div class="slidecontainer">\
					<div class="horizontal">\
						<div class="horizontal-position-header">\
							<div class="horizontal-position-title">Horizontal</div>\
							<input type="number" class="slider-horizontal-tooltip" min="-100" max="100" value="0">\
						</div>\
